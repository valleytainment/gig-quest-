/** 🟧 UI │ StatusPill — Application and workflow status badge. */
...
export const StatusPill = ({ status, className }: StatusPillProps) => (
  <span
    className={cn(
      'gq-status-pop inline-flex items-center rounded-full border px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.14em]',
